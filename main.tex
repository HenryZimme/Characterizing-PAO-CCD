...
\[
\sigma_{r, e^-} = (\sigma_r \cdot g) \pm \sigma_{r, e^-} \sqrt{\left(\frac{\Delta g}{g}\right)^2 + \left(\frac{\Delta \sigma_{r, \text{ADU}}}{\sigma_{r, \text{ADU}}}\right)^2} = \boxed{12.22 \pm 0.11 \text{ e}^-}
\]
...
$$
We can find the signal $S_k$, by averaging the counts of the two flats that were differenced (after performing bias subtraction). $$S_k = \frac{\langle F_{k, 1} \rangle + \langle F_{k, 2} \rangle}{2} - \bar B $$
...
$Var(S) = \frac{\langle F_{k, 1} + F_{k, 2}\rangle}{2g_k} - \frac{\bar B}{g_k}$, which can be simplified to $$g_k =\frac {S_k}{Var(S)}$$
...
\[
\text{SEM}_{gain} = \frac{\sqrt{\frac{\sum_{i=1}^{n_D} (g_i - \bar{g})^2}{n_D-1}}} {\sqrt{n_D}} = 0.013
\]
...
\begin{table} [H]
    ...
    \begin{tabular}{
        ...
        \midrule
        1 & 99.0465   & 5    & 9810.209162 & 4905.104581 & 4831.738504 & 6822.744957  & 1.412068338\\
        2 & 122.72687 & 7.5  & 15061.88462 & 7530.94231  & 7457.576233 & 10600.89291 & 1.421493066 \\
        3 & 144.18086 & 10   & 20788.12039 & 10394.0602  & 10320.69412 & 14490.4056 & 1.404014637 \\
        4 & 172.62817 & 15   & 29800.48508 & 14900.24254 & 14826.87646 & 21298.29916 & 1.436465679 \\
        5 & 185.99951 & 17.5 & 34595.81772 & 17297.90886 & 17224.54278 & 25580.14844 & 1.485098836 \\
        6 & 202.48605 & 20   & 41000.60044 & 20500.30022 & 20426.93415 & 28620.36068 & 1.401108971 \\
        \bottomrule
    \end{tabular}
...
$$ \langle g_k \rangle = 1.427$$ $$\tilde{g_k} = 1.4167$$ 
\begin{center}
\fbox{$g_k = 1.427 \pm 0.013\footnote{This value, which is an average and thus has easily quantified errors, will be used for converting the read noise to $e^-$ in \ref{readnoisecalc}} $}
\end{center}
